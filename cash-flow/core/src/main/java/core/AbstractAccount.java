...
public abstract class AbstractAccount {
    ...
    /**
     * Top level account which contains all the shared methods like depositing, transfering etc.
     * Cannot create an instance of this top-level account.
    ...
    /**
     * Top level account which contains all the shared methods like depositing, transfering etc.
     * Cannot create an instance of this top-level account. The account number is generated by
     * going from the number 1000 to 9999 and checking for an available account number.
     * @param name the name of the account
     * @param owner the owner of the account
     */
     ...
     * @return the available account number, {@code -1} if no available account number, or
     * {@code 1000} if the user is {@code null}.
     */
    ...
    /**
     * Sets the owner of the account. The account cannot go from having an owner to not
     * having an owner. Therefore if the owner parameter is null, this method does nothing.
