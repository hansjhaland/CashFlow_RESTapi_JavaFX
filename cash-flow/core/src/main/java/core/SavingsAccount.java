...
public class SavingsAccount extends AbstractAccount {
     ...
     * @throws IllegalArgumentException if the account number already exists in the users 
    ...
    /**
     * Initializes a new SavingsAccount-object, and also generates the next available account number for 
     ...
     * @throws IllegalStateException if the maximum number of withdrawals and transfers from this account 
     ...
     * @throws IllegalStateException if the maximum number of withdrawals and transfers has been reached,
     * which is 10
     */
    @Override
    ...
    private void checkIfWithdrawalOrTransferPossible() {
        if (!isWithdrawalOrTransferPossible()) {
            throw new IllegalStateException("Cannot withdraw, because number of withdrawals and transfers have been reached (10)");
        }
    }

    /**
     * Checks if the number of withdrawals and transfer hase been reached. This limit is set to 
     * be 10 withdrawals or transfers.
