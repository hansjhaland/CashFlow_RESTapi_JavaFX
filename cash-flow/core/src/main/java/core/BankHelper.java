...
/**
 * Library for checking and validating certain parameters and conditions
 * for all our cashflow-objects.
 */
public final class BankHelper {
     ...
     */
    static public boolean isPositiveAmount(double amount) {
        return amount >= 0;
    }
     ...
     */
    static public boolean isBalanceValidWhenAdding(double amount, AbstractAccount account) {
        double newBalance = account.getBalance() + amount;
        return newBalance >= 0;
    }

    static public boolean hasBSU(User user) {
    ...
    static public boolean isOnlyLettersAndSpaces(String s) {
