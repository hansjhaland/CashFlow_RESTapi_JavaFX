...
/**
 * Configures the REST-service, saying it should use
 * JSON with Jackson library, inject a User-object
 * using a binder, etc.
 */
public class CashFlowConfig extends ResourceConfig{
    ...
    /**
     * Initializes the CashFlowConfig with a default User-object
