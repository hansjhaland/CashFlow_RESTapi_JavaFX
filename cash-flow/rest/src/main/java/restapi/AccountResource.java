...
/**
 * Sub-resource of UserRestService. Is used to update information regarding
 * the users accounts.
 */
...
public class AccountResource {
    ...
    /**
     * Method for getting the account, indicating
     * that the method responds to HTTP-GET requests.
     * @return the account
     */
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    ...
    /**
     * Method for adding an account or updating the account if 
     * it already exists, indicating that the method responds 
     * to HTTP-PUT requests.
    ...
    /**
     * Method for deleting/removing an account, indicating
     * that the method responds to HTTP-DELETE requests.
