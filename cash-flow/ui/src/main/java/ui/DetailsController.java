...
/**
 * A controller for details and transfer of accounts for the user and display it with its
 * correspondig FXML file.
 */
...
public class DetailsController {
  ...
  @FXML
  private TextField setBalance;
  @FXML
  private TextArea accountHistory;
  @FXML
  private TextArea accounts;
  @FXML
  private Button createAccount;
  @FXML
  private Button detailsAndTransfers;
  @FXML
  ...
  @FXML
  private ChoiceBox<String> transferAccount;
  ...
  /**
   * Initializer runs the methods on the app if access is granted and updates the history of the
   * actions taken by the account and balance.
   */
  @FXML
  ...
  /**
   * The method updates the transaction history if there is an account. Than it formats the
   * transactiondetails in a representable way with from-account, to-account and balance that was
   * transfered.
   */
  ...
  /**
   * Updates the pageview when changes occur, such as a transfer. The method also 
   * format the data from the account in the pageview in a representable form.
   */
  private void updateChooseAccountView() {
    ...
    for (AbstractAccount account : user.getAccounts()) {
      ...
      transferAccount.getItems().add(type + "; " + account.getName() 
  ...
  /**
   * Method that happens when choosing an account and formats its sccount and balance in the
   * choicebox. If there is no accounts in the account choicebox, it does not do anything and set
   * account null. Else it formats the number in a representable way and gets the accountnumber from
   * the Remote or Locally (Rest APi).
   */
  @FXML
  ...
  /**
   * Deletes an account when button is pushed. Deletes the accountnumber 
   * only if there is no amount on the account from either Remote or Locally (rest API).
   */
  @FXML
  ...
  private void onPreviousPage() throws IOException {
    ...
    FXMLLoader fxmlLoader = new FXMLLoader(
        getClass().getResource(cashFlowAccess instanceof DirectAccess 
            ? "LocalCashFlow.fxml" : "RemoteCashFlow.fxml"));
